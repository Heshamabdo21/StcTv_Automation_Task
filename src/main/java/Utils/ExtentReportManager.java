...
public class ExtentReportManager {
	...
	public static ExtentReports createInstance() throws IOException {
        ...
        esr.config().setDocumentTitle("STC.TV Automation Task");
        esr.config().setReportName("Hesham Abd Elhamed");
	...
	public static synchronized void log(Status status, Throwable e) {
		logger.get().log(status, e);
	}
